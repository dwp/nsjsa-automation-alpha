...
const LIMIT_WARNING_PATH = '/sprint9/1/9-pensions/limit-warning';
const BASE_PATH = 'sprint9/1/9-pensions/9a-current-pension';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/sprint9/1/10-education';
