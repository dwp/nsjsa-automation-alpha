...
const BASE_PATH = 'sprint8/1/5-jury-service';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/sprint8/1/6-current-employment';
...
router.post('/have-been', function (req, res) {
  ...
  //   res.redirect('/sprint8/1/5-jury-service/period');
  // } else {
  //   res.redirect('/sprint8/1/6-current-employment');
  // }
