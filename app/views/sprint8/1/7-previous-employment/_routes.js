...
const BASE_PATH = 'sprint8/1/7-previous-employment';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/sprint8/1/8-abroad';
...
router.get('/', function (req, res) {
  res.redirect('/sprint8/1/7-previous-employment/job-ended-last-six-months');
});
